      ...
      <section className="dark:bg-darkmode pt-8 pb-24">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4">
          ...
          <div className="md:pt-32 pt-11 md:pb-28 pb-8">
            <iframe src="https://www.google.com/maps?q=Fulya,+Ye%C5%9Fil%C3%A7imen+Soka%C4%9F%C4%B1+12%2F430,+34394+%C5%9Ei%C5%9Fli%2F%C4%B0stanbul&output=embed" width="1114" height="477" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg w-full"></iframe>
          </div>
        </div>
